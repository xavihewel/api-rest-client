 ...
 */
package com.ba.rrhh.api.rest.client;
...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/myfirst-webservice/resources";

    public NewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("StudentFacadeREST");
    }
